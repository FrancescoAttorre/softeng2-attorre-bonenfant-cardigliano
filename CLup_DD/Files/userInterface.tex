\subsection {UserMobileApp Interfaces}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.32\textwidth]{/MockUps/Start}
	\caption{Starting page}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.32\textwidth]{/MockUps/HomePage}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{/MockUps/Home}
	\caption{List of tickets of a customers, with the possibility to view the related QR code}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{/MockUps/Registration}
	\caption{List of tickets of a customers, with the possibility to view the related QR code}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{/MockUps/InsertBuilding}
	\caption{List of tickets of a customers, with the possibility to view the related QR code}
\end{figure}
\newpage
